...
VT.TodoItemInput = function (el) {
  ...
  el.innerHTML = [
    '<input type="text" class="input use-focus-other" aria-label="New task">',
    '<button class="app-button save" aria-label="Add task"><i class="app-icon" data-id="plus-24"></i></button>',
  ].join('\n');
