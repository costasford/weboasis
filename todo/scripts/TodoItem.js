...
VT.TodoItem = function (el) {
  ...
  el.innerHTML = [
    ...
    '<p class="label"></p>',
    '<p class="form">',
    '  <input type="text" class="input use-focus-other" aria-label="Edit task">',
    '  <button class="app-button save" aria-label="Save task"><i class="app-icon" data-id="check-16"></i></button>',
    '</p>',
  ].join('\n');
