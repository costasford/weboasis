...
VT.TodoCustomList = function (el) {
  ...
  el.innerHTML = [
    ...
    '  <h3 class="title"></h3>',
    '  <p class="form">',
    '    <input type="text" class="input use-focus-other" aria-label="List name">',
    '    <button class="app-button delete" aria-label="Delete list"><i class="app-icon" data-id="trashcan-16"></i></button>',
    '  </p>',
    '</div>',
