...
VT.TodoFrameCustom = function (el) {
  ...
  el.innerHTML = [
    ...
    '  <p><button class="app-button -circle -xl back" aria-label="Previous list"><i class="app-icon" data-id="chevron-left-24"></i></button></p>',
    '</div>',
    '<div class="container"></div>',
    '<div class="rightcontrols">',
    '  <p><button class="app-button -circle -xl forward" aria-label="Next list"><i class="app-icon" data-id="chevron-right-24"></i></button></p>',
    '  <p><button class="app-button -circle -xl add" aria-label="Add new list"><i class="app-icon" data-id="plus-circle-24"></i></button></p>',
    '</div>',
  ].join('\n');
