...
function customLinkRemoveConfirmation(a){var b=a.srcElement.attributes["data-category"].nodeValue,c=a.srcElement.attributes["data-index"].nodeValue;a=getCustomLinkItems()[b][c][0];confirmModal.style.display="block";overlay.style.display="block";document.getElementById("modal-label").innerHTML=a;currentDeleteHandler&&document.getElementById("deleteLink").removeEventListener("click",currentDeleteHandler);currentDeleteHandler=function(){removeCustomLink(b,c);confirmModal.style.display="none";overlay.style.display="none"};document.getElementById("deleteLink").addEventListener("click",currentDeleteHandler,{once:!0})}var perfectSrollBars={customLinks:null};
