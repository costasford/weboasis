    ...
    480: function (e, t, a) {
      ...
      var r = a(0),
        ...
        T = [
          ...
          { name: "Marc Ruef", url: "https://www.scip.ch/en/?feed=rss2" },
          ...
          { name: "Samy Kamkar", url: "https://samy.pl/rss.xml" },
          { name: "Kirby Plessas", url: "https://www.plessas.net/feed" },
          { name: "Dan Goodin", url: "https://arstechnica.com/author/dan-goodin/feed/" },
          { name: "Mike West", url: "https://www.mikewest.org/feed" },
        ],
        D = a(169),
        j = O.object({
